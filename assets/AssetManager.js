class AssetManager {
    ...
    async loadWeapons() {
        const weapons = [
            { name: 'ak47', folder: 'src/assets/weapons/', filename: 'ak47.glb' },
            { name: 'pistol', folder: 'src/assets/weapons/', filename: 'pistol.gltf' },
            { name: 'sniper', folder: 'src/assets/weapons/', filename: 'sniper.glb' }
        ];
    ...
    async loadMapProps() {
        const props = [
            { name: 'crate', folder: 'src/assets/props/', filename: 'crate.glb' },
            { name: 'barrel', folder: 'src/assets/props/', filename: 'barrel.glb' },
            { name: 'wall_section', folder: 'src/assets/props/', filename: 'wall.gltf' }
        ];
...
// await assetManager.loadWeapons();
// const ak47Meshes = assetManager.cloneModel('ak47', 'player_weapon');
