...
export class Player {
    ...
    createCamera() {
        ...
        this.camera.attachToCanvas(this.game.canvas, true);
    ...
    updateShooting(deltaTime) {
        ...
        if (this.inputState.shoot && this.canShoot && this.currentWeapon) {
            this.shoot();
        }
    }
     ...
     */
    shoot() {
        if (!this.canShoot || !this.currentWeapon) return;
        ...
        // Trigger shooting event (will be handled by weapon system)
